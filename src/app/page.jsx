...
const Header = ({ currentPage, setCurrentPage }) => {
  ...
  // Handle focus trap and Escape key for mobile menu
  useEffect(() => {
    ...
    <div className="bg-[#0f172a] text-white py-2 px-4 text-xs hidden sm:block">
        <div className="container mx-auto flex justify-between items-center max-w-[1200px]">
            <div className="flex items-center gap-4">
                <a href="tel:+918655294908" className="flex items-center gap-1.5 hover:text-[#fb923c] transition-colors">
  ...
  return (
    <>
      ...
      <header className={`sticky top-0 z-[1000] transition-all duration-300 ${isScrolled ? 'h-[72px] shadow-lg bg-white/95 backdrop-blur-[20px] border-b border-gray-300' : 'h-[80px] bg-white/95 backdrop-blur-[20px] border-b border-gray-200'}`}>
       ...
       <div 
         ref={mobileMenuRef}
         className={`fixed top-0 right-0 h-full w-[320px] bg-white shadow-2xl z-[1001] transform transition-transform duration-250 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} lg:hidden`}
         role="navigation"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start">
                                ...
                                <a href="tel:+918655294908" className="text-gray-400 hover:text-white transition-colors">+91 8655294908</a>
                            </li>
                            <li className="flex items-start">
...
const ContactPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        .catch(() => {
            // Fallback - show success anyway for user feedback
            setFormSubmitted(true);
            setTimeout(() => {
                setFormSubmitted(false);
                e.target.reset();
                         ...
                         <div className="space-y-6 text-[#475569]">
                             <div className="flex items-start">
                                 ...
                                 <div>
                                     ...
                                     <a href="tel:+918655294908" className="text-gray-400 hover:text-[#f97316] transition-colors">+91 8655294908</a>
